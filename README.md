...
- About App
- Settings App: currently only lets you change your wallpaper, a change which it stores in local storage
- Notes App: A simple notes app that stores it's data in local storage 
